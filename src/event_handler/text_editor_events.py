...
commands_pressed = {
    ...
    # NO MODIFIERS
    (NONE,KEY.F1):  lambda window: print('not implemented: help (basically manual'),
    (NONE,KEY.F2):  lambda window: print('not implemented: far says it\' UserMn but it just shows random menu to me'),
    (NONE,KEY.F3):  lambda window: print('not implemented: view (like using less command)'),
    (NONE,KEY.F4):  lambda window: window.switchWidget(),
    (NONE,KEY.F5):  lambda window: print('not implemented:copy'),
    (NONE,KEY.F6):  lambda window: print('not implemented:move'),
    (NONE,KEY.F7):  lambda window: print('not implemented'),
    (NONE,KEY.F8):  lambda window: print('not implemented'),
    (NONE,KEY.F9):  lambda window: print('not implemented:options'),
    (NONE,KEY.F10): lambda window: print('not implemented:quit'),
    (NONE,KEY.F11): lambda window: print('not implemented: plugins'), # do I need them?
    (NONE,KEY.F12): lambda window: print('not implemented: screens'), # I don't use them myself, so hard to say
