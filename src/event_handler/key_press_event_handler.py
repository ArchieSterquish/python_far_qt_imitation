...
class KeyHandler:
    ...
    def handle_key_press(event: QKeyEvent):       
        return KeyHandler.get_key_handler(KeyHandler.commands_pressed,event.key(),event.modifiers())
    def handle_key_release(event: QKeyEvent):
        return KeyHandler.get_key_handler(KeyHandler.commands_released,event.key(),event.modifiers())
